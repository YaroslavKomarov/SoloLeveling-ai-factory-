 ...
 *   4. Generates embeddings via OpenRouter (openai/text-embedding-3-small, 1536-dim)
 ...
 * Env vars required: SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, OPENROUTER_API_KEY
 */
...
Deno.serve(async (_req) => {
  ...
  log('Using OpenRouter for embeddings (openai/text-embedding-3-small)')
  const openai = new OpenAI({ apiKey: openRouterKey, baseURL: 'https://openrouter.ai/api/v1' })
