...
import { getGoalsByUser, saveDialogMessage, getDialogMessages, getActiveGoalBySphere, clearDialogMessages } from '@/lib/supabase/goals'
 ...
 * Clear all dialog messages for a sphere after goal creation completes.
 */
export async function DELETE(request: NextRequest) {
  try {
    ...
    logger.info('[FIX] dialog messages cleared after goal creation', { userId: user.id, sphereId })
